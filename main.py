...
# System info using os and platform libraries
...
while input_invalid and i in range(5):
    ...
    if (not hero.combat_strength.isnumeric()) or (not monster.combat_strength
            .isnumeric()):
    ...
    elif (int(hero.combat_strength) not in range(1, 7)) or (int(monster.combat_strength
                                                                )) not in range(1, 7):
...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    # Use Loot
    belt, hero.health_points = functions.use_loot(belt, hero)
    ...
    while monster.health_points > 0 and hero.health_points > 0:
        ...
        if not (attack_roll % 2 == 0):
            ...
            monster.health_points = hero.hero_attacks(monster, element_advantage)
            if monster.health_points == 0:
                ...
                hero.health_points = monster.monster_attacks(hero, element_advantage)
